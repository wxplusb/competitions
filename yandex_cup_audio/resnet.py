...
class ResNet(nn.Module):
    def __init__(self,input_shape,n_class):
        ...
        self.conv1_x = torch.nn.Conv1d(in_channels=INPUT_CHANNELS, out_channels=n_feature_maps, kernel_size=kernel_size)
        ...
        self.conv1_sy = torch.nn.Conv1d(in_channels=INPUT_CHANNELS, out_channels=n_feature_maps, kernel_size=1)
